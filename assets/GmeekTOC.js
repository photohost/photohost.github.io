function createTOC() {
    ...
    tocElement.insertAdjacentHTML('afterbegin', '<div class="toc-title">目次</div>');
    ...
    tocElement.insertAdjacentHTML('beforeend', '<a class="toc-end" onclick="window.scrollTo({top:0,behavior: \'smooth\'});">Go Top</a>');
